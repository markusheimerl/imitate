...
Tensor* transformer_layer(Tensor* x, Tensor* mask, int num_heads, float eps,
...
int main() {
    ...
    const int input_dims[] = {batch_size, seq_len, d_model};
    ...
    const int mask_dims[] = {batch_size, num_heads, seq_len, seq_len};
    ...
    const int ff1_dims[] = {d_model, ff_dim};
    const int ff2_dims[] = {ff_dim, d_model};
